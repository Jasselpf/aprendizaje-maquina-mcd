...
**Note Class** nse = root mean square error
...
**Note** redicir sezgo al agregar variables
...
**Note class** Feature ingeneering - agregar nuevas variables que dependan de las originales
