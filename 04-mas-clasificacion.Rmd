...
desempe?o de un modelo. En la parte anterior vimos que
...
**NOTA clase:** generalmente en machine learning se utiliza Sensibilidad (o recall) & Precisión. Y en estadística Especificidad & Valor predictivo negativo.
Hay que utilizar las dos medidas.

En problemas de clasificación, el porcentage de clasificación correcto depende de las probabilidades de clase.
Por ejemplo si tenemos 4 clases con esta distribución:
#1 - 40%, #2 - 20%, #3 - 10%, #4 - 30%. 
Si todo lo clasficamos en categoría 1, ya tenemos al menos un 40% de clasificación correcto.
...
**Nota Clase* verificar en que parte de la gráfica quedaría el negativo del clasificador que está por debajo de la diagonal
